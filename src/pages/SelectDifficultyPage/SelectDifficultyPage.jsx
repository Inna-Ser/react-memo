      ...
      <div className={styles.modal}>
        ...
        <ul className={styles.levels}>
          <li className={styles.level}>
            <Link className={classNames(styles.levelLink, styles.active)} onClick={() => onChangeLifes(3)}>
              1
            </Link>
          </li>
          <li className={styles.level}>
            <Link className={classNames(styles.levelLink, styles.active)} onClick={() => onChangeLifes(2)}>
              2
            </Link>
          </li>
          <li className={styles.level}>
            <Link className={classNames(styles.levelLink, styles.active)} onClick={() => onChangeLifes(1)}>
              3
            </Link>
          </li>
        </ul>
